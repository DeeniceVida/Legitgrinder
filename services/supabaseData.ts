...
export const fetchInvoicesData = async (): Promise<Invoice[]> => {
    try {
        ...
        return (data || []).map((inv: any) => ({
            ...
            buyingPriceKES: parseFloat(inv.buying_price_kes || 0),
            shippingFeeKES: parseFloat(inv.shipping_fee_kes || 0),
            logisticsCostKES: parseFloat(inv.logistics_cost_kes || 0),
    ...
    try {
        ...
        const { data, error } = await supabase
            ...
            .insert({
                ...
                buying_price_kes: invoiceData.buyingPriceKES || 0,
                shipping_fee_kes: invoiceData.shippingFeeKES || 0,
                logistics_cost_kes: invoiceData.logisticsCostKES || 0,
                service_fee_kes: invoiceData.serviceFeeKES || 0,
